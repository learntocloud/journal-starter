...
class EntryUpdate(BaseModel):
    work: JournalInput | None = None
    struggle: JournalInput | None = None
    intention: JournalInput | None = None
